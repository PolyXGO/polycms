...
class UpdateBannerRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'countdown_repeat' => ['sometimes', 'nullable', 'string', 'in:none,hourly,daily'],
            'countdown_duration' => ['sometimes', 'nullable', 'integer', 'min:0'],
            'padding_x' => ['sometimes', 'nullable', 'integer', 'min:0', 'max:150'],
            'padding_y' => ['sometimes', 'nullable', 'integer', 'min:0', 'max:100'],
        ];
    }
