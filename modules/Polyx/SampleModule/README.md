...
class YourModuleServiceProvider extends ServiceProvider
{
    public function boot(): void
    {
        ...
        Hook::addAction('roles.register_permissions', function (PermissionRegistry $permissions) {
            $permissions->registerMany([
                [
                    'name' => 'your_module.manage',
                    'label' => 'Manage Your Module',
                    'group' => 'your_module',
                    'module_owner' => 'Polyx.YourModule',
                ],
            ]);
        });
