...
This project uses [HeraSpec](https://github.com/PolyXGO/HeraSpec) for spec-driven development.
...
For more information, see the [HeraSpec documentation](https://github.com/PolyXGO/HeraSpec/docs).

---

*This section is automatically updated by `heraspec init`. Last updated: 2026-05-04*