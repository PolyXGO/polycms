        ...
        <div class="reading-container">
            ...
            <div class="post-scroll-tools">
                <div class="post-scroll-tools-inner">
                    <button class="scroll-btn" id="scroll-to-top" aria-label="Scroll to top" title="Scroll to top">
                        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 10l7-7m0 0l7 7m-7-7v18" />
                        </svg>
                    </button>
                    <button class="scroll-btn" id="scroll-to-bottom" aria-label="Scroll to bottom" title="Scroll to bottom">
                        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            @if($post->featured_image)
                <img src="{{ $post->featured_image }}" alt="{{ $post->title }}" class="post-cover" loading="lazy">
            @endif
