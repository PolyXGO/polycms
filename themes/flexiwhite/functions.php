...
Hook::addAction('theme.activated', function ($theme) {
    ...
    \Log::info('[SampleTheme] Initializing landing page...');
...
<section class="lp-hero">
    <div class="container">
        <h1 class="lp-hero-title">Build something amazing,<br>ship it faster.</h1>
        <p class="lp-hero-subtitle">
            A modern, lightweight content management system built for performance, flexibility, and developer happiness.
        </p>
        <div class="lp-hero-actions">
            <a href="/posts" class="btn btn-primary btn-lg">Explore the Blog</a>
            <a href="/products" class="btn btn-secondary btn-lg">Browse Products</a>
        </div>
    </div>
</section>
...
<section class="lp-features">
    <div class="container">
        <div class="lp-features-header">
            <h2>Why Choose PolyCMS</h2>
            <p>Everything you need to build, manage, and scale your content.</p>
        </div>
        <div class="lp-features-grid">
            <div class="lp-feature-card">
                <svg class="lp-feature-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><path d="M13 2L3 14h9l-1 8 10-12h-9l1-8z"/></svg>
                <h3>Blazing Fast</h3>
                <p>Optimized architecture with smart caching delivers sub-second page loads, ensuring the best experience for your visitors.</p>
            </div>
            <div class="lp-feature-card">
                <svg class="lp-feature-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg>
                <h3>Secure by Default</h3>
                <p>Enterprise-grade security with CSRF protection, input sanitization, and role-based access control built into every layer.</p>
            </div>
            <div class="lp-feature-card">
                <svg class="lp-feature-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><rect x="3" y="3" width="7" height="7"/><rect x="14" y="3" width="7" height="7"/><rect x="14" y="14" width="7" height="7"/><rect x="3" y="14" width="7" height="7"/></svg>
                <h3>Modular Design</h3>
                <p>Extend functionality with themes and modules. Install, activate, and customize — no core modifications needed.</p>
            </div>
            <div class="lp-feature-card">
                <svg class="lp-feature-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><circle cx="12" cy="12" r="10"/><path d="M2 12h20"/><path d="M12 2a15.3 15.3 0 014 10 15.3 15.3 0 01-4 10 15.3 15.3 0 01-4-10A15.3 15.3 0 0112 2z"/></svg>
                <h3>Multi-Language Ready</h3>
                <p>Full internationalization support with RTL layouts, translation management, and locale-aware content delivery.</p>
            </div>
            <div class="lp-feature-card">
                <svg class="lp-feature-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><path d="M12 20V10"/><path d="M18 20V4"/><path d="M6 20v-4"/></svg>
                <h3>SEO Optimized</h3>
                <p>Clean semantic markup, structured data, customizable meta tags, and auto-generated sitemaps to maximize your search visibility.</p>
            </div>
            <div class="lp-feature-card">
                <svg class="lp-feature-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><path d="M16 18l6-6-6-6"/><path d="M8 6l-6 6 6 6"/></svg>
                <h3>Developer Friendly</h3>
                <p>Built on Laravel with Blade templates, a powerful Hook system, REST API, GraphQL, and comprehensive documentation for rapid development.</p>
            </div>
        </div>
    </div>
</section>
...
<div class="container">
    <div class="lp-stats">
        ...
        <div class="lp-stat">
            <div class="lp-stat-value">&lt;200ms</div>
            <div class="lp-stat-label">Response Time</div>
        </div>
        <div class="lp-stat">
            <div class="lp-stat-value">50+</div>
            <div class="lp-stat-label">Hooks &amp; Filters</div>
        </div>
        <div class="lp-stat">
...
<section class="lp-cta">
    <div class="container">
        ...
        <p>Set up your site in minutes. No credit card required.</p>
...
Hook::addFilter('settings.defaults', function ($defaults) {
    $defaults['theme_options']['flexiwhite_header_menu_align'] = [
        ...
        'default'       => 'right',
        'group'         => 'theme_options',
        'section'       => 'flexiwhite_header',
        'section_label' => _l('Header Settings'),
        'section_order' => 10,
    ];
    ...
    $defaults['theme_options']['flexiwhite_footer_copyright'] = [
        ...
        'default'       => '',
        'group'         => 'theme_options',
        'section'       => 'flexiwhite_footer',
        'section_label' => _l('Footer Settings'),
        'section_order' => 80,
    ];
    ...
    $defaults['theme_options']['flexiwhite_posts_columns'] = [
        ...
        'default'       => '3',
        'group'         => 'theme_options',
        'section'       => 'flexiwhite_listing',
        'section_label' => _l('Listing Layout'),
        'section_order' => 70,
    ];
