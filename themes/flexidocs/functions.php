...
Hook::addFilter('settings.defaults', function ($defaults) {
    ...
    $defaults['theme_options']['flexidocs_doc_prefix'] = [
        ...
        'label' => _l('Documentation Route Prefix'),
        'description' => _l('The customizable URL base for the wiki (e.g., "docs" for /docs/category/post)'),
        'type' => 'string',
        'default' => 'docs',
        'group' => 'theme_options',
        'section' => 'flexidocs_settings',
        'section_label' => _l('FlexiDocs Settings'),
        'section_description' => _l('Settings for the FlexiDocs documentation theme. Applies when FlexiDocs is active as a Sub Theme to provide wiki-style documentation alongside the main theme.'),
        'section_order' => 90,
    ];

    $defaults['theme_options']['flexidocs_header_search_enabled'] = [
        'key' => 'flexidocs_header_search_enabled',
        'label' => _l('Show Header Search Icon'),
        'description' => _l('Display the search trigger in the docs header before the language switcher.'),
        'type' => 'boolean',
        'default' => true,
        'group' => 'theme_options',
        'section' => 'flexidocs_settings',
        'section_label' => _l('FlexiDocs Settings'),
        'category' => 'flexidocs_header',
        'category_label' => _l('Header Settings'),
        'order' => 92,
    ];

    $defaults['theme_options']['flexidocs_header_search_style'] = [
        'key' => 'flexidocs_header_search_style',
        'label' => _l('Header Search Display Style'),
        'description' => _l('Choose how the header search opens.'),
        'type' => 'select',
        'options' => [
            'icon_modal' => _l('Icon opens modal'),
            'icon_expand' => _l('Icon expands absolute input'),
            'icon_inline' => _l('Inline input with icon'),
        ],
        'default' => 'icon_modal',
        'group' => 'theme_options',
        'section' => 'flexidocs_settings',
    ...
    $defaults['theme_options']['flexidocs_header_search_trigger_variant'] = [
        'key' => 'flexidocs_header_search_trigger_variant',
        'label' => _l('Header Search Trigger Appearance'),
        'description' => _l('Use icon-only styling for the search trigger button.'),
        'type' => 'select',
        'options' => [
            'button' => _l('Button chrome'),
            'icon' => _l('Icon only'),
        ],
        'default' => 'icon',
        'group' => 'theme_options',
    ...
    $defaults['theme_options']['flexidocs_header_search_placeholder'] = [
        'key' => 'flexidocs_header_search_placeholder',
        'label' => _l('Header Search Placeholder'),
        'description' => _l('Placeholder text shown inside the docs search input.'),
        'type' => 'string',
        'default' => _l('Search documentation...'),
        'group' => 'theme_options',
        'section' => 'flexidocs_settings',
        'section_label' => _l('FlexiDocs Settings'),
        'category' => 'flexidocs_header',
    ...
    $defaults['theme_options']['flexidocs_sidebar_search_enabled'] = [
        'key' => 'flexidocs_sidebar_search_enabled',
        'label' => _l('Show Sidebar Search'),
        'description' => _l('Display a documentation search input above the left navigation panel.'),
        'type' => 'boolean',
        'default' => true,
        'group' => 'theme_options',
        'section' => 'flexidocs_settings',
        'section_label' => _l('FlexiDocs Settings'),
        'category' => 'flexidocs_sidebar',
        'category_label' => _l('Sidebar Settings'),
        'order' => 95,
    ];

    $defaults['theme_options']['flexidocs_sidebar_search_placeholder'] = [
        'key' => 'flexidocs_sidebar_search_placeholder',
        'label' => _l('Sidebar Search Placeholder'),
        'description' => _l('Placeholder text shown inside the left documentation search input.'),
        'type' => 'string',
        'default' => _l('Search documentation...'),
        'group' => 'theme_options',
        'section' => 'flexidocs_settings',
    ...
    $defaults['theme_options']['flexidocs_footer_copyright'] = [
        'key'           => 'flexidocs_footer_copyright',
        'label'         => _l('Footer Copyright Text'),
        'description'   => _l('Custom copyright text for the footer. Leave empty for default. Supports HTML.'),
        'type'          => 'html',
        'default'       => '&copy; ' . date('Y') . ' ' . e(app(\App\Services\SettingsService::class)->get('site_title', 'PolyCMS')) . '. ' . _l('All rights reserved.'),
        'group'         => 'theme_options',
        'section'       => 'flexidocs_settings',
        'section_label' => _l('FlexiDocs Settings'),
        'category'      => 'flexidocs_footer',
        'category_label'=> _l('Footer Settings'),
        'order'         => 97,
    ];

    $defaults['theme_options']['flexidocs_footer_powered_by'] = [
        'key'           => 'flexidocs_footer_powered_by',
