...
class HookManager
{
    ...
    /**
     * Prevent infinite recursion in webhook dispatching.
     */
    protected bool $isDispatchingWebhooks = false;
    ...
    protected function dispatchWebhooks(string $hookName, array $args): void
    {
        ...
        $this->isDispatchingWebhooks = true;

        try {
            if (!\Illuminate\Support\Facades\Schema::hasTable('webhooks')) {
                return;
            }
            ...
            $this->isDispatchingWebhooks = false;
        }
    }
