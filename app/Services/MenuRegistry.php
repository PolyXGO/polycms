...
class MenuRegistry
{
    ...
    /**
     * Add a child item to an existing menu
     *
     * @param string $parentKey Key of the parent menu item
     * @param array $child Child menu item data
     * @return void
     */
    public function addChild(string $parentKey, array $child): void
    {
        if (isset($this->menuItems[$parentKey])) {
            $this->menuItems[$parentKey]['children'][] = $child;
        }
    }
