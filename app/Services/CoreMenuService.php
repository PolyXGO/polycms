...
class CoreMenuService
{
    ...
    public function registerCoreMenus(): void
    {
        ...
        $this->menuRegistry->register('posts', [
            ...
            'permissions' => ['view-any post', 'create post', 'view-any category', 'view-any tag'],
            'order' => 20,
            'children' => [
                [
                    'key' => 'posts-all',
        ...
        $this->menuRegistry->register('pages', [
            ...
            'permissions' => ['view-any post', 'create post'],
            'order' => 25,
            'children' => [
                [
                    'key' => 'pages-all',
        ...
        $this->menuRegistry->register('products', [
            ...
            'permissions' => ['view-any product', 'create product', 'view-any category', 'view-any tag'],
            'order' => 30,
            'children' => [
                [
                    'key' => 'products-all',
        ...
        $this->menuRegistry->register('ecommerce', [
            ...
            'permissions' => ['view-any order', 'view-any coupon', 'view-any subscription', 'view-any license', 'manage settings'],
            'order' => 35,
            'children' => [
                [
                    'key' => 'orders',
                ...
                [
                    ...
                    'icon' => null,
                    'permission' => 'view-any subscription',
                    'order' => 3,
                ],
                [
                    'key' => 'licenses',
        ...
        $this->menuRegistry->register('payments', [
            ...
            'permissions' => ['view-any order', 'manage settings'],
            'order' => 36,
            'children' => [
                [
                    'key' => 'transactions',
        ...
        try {
            if (\Illuminate\Support\Facades\Schema::hasTable('contacts')) {
                $unreadCount = \App\Models\ContactSubmission::where('status', 'unread')->count();
            }
        } catch (\Exception $e) {
            // Ignore DB errors during migration/installation
        }

        $this->menuRegistry->register('contacts', [
            'key' => 'contacts',
            'label' => 'Contact',
            ...
            'children' => [
                [
                    'key' => 'contacts-submissions',
                    'label' => 'Contacts',
                    'route' => 'admin.contacts.submissions',
                    'icon' => null,
                    'order' => 1,
                ],
                [
        ...
        $this->menuRegistry->register('users', [
            ...
            'permissions' => ['view users', 'manage roles'],
            'order' => 73,
            'children' => [
                [
                    'key' => 'users-all',
        ...
        $this->menuRegistry->register('appearance', [
            ...
            'permissions' => ['view themes', 'manage theme options', 'view layout assets', 'view widgets'],
            'order' => 65,
            'children' => [
                [
                ...
                [
                    ...
                    'icon' => null,
                    'permission' => 'view layout assets',
                    'order' => 3,
                ],
                [
                    'key' => 'appearance-categories',
                    'label' => 'Categories',
                    'route' => 'admin.appearance.categories.index',
                    'icon' => null,
                    'permission' => 'view-any category',
                    'order' => 4,
                ],
                ...
                [
                    ...
                    'label' => 'Presets',
                    'route' => 'admin.appearance.presets',
                    'icon' => null,
                    'permission' => 'manage theme options',
                    'order' => 8,
                ],
