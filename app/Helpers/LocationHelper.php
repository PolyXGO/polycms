...
class LocationHelper
{
    ...
    public static function getStates(): array
    {
        return [
          ...
          "CL" => [
                    ...
                    "CL-BI" => "Biobío",
                    "CL-CO" => "Coquimbo",
                    "CL-LI" => "Libertador General Bernardo O\\",
                    "CL-LL" => "Los Lagos",
                    "CL-LR" => "Los Ríos",
                    "CL-MA" => "Magallanes",
                    "CL-ML" => "Maule",
    ...
    public static function getCountriesWithStates(): array
    {
        ...
        foreach ($countries as $code => $name) {
            $countryStatesList = [];
            if (isset($states[$code]) && is_array($states[$code])) {
                foreach ($states[$code] as $stateCode => $stateName) {
                    $countryStatesList[] = [
                        'code' => $stateCode,
                        'name' => $stateName,
                    ];
            ...
            $result[] = [
                'code' => $code,
                'name' => $name,
                'states' => $countryStatesList,
            ];
        }
        
        // Add "Everywhere" wildcard option at the beginning
