...
class ProductBrand extends Model
{
    ...
    public function getFrontendUrlAttribute(): string
    {
        ...
        $url = '/' . $base . '/' . $this->slug;
        return \App\Facades\Hook::applyFilters('product_brand.frontend_url', $url, $this);
    }
     ...
     */
    public static function getTree(?string $locale = null): \Illuminate\Support\Collection
    {
        $query = static::query();
