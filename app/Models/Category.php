...
class Category extends Model
{
    ...
    public function getFrontendUrlAttribute(): string
    {
        ...
        $url = $base === '' ? '/' . $this->slug : '/' . $base . '/' . $this->slug;
     ...
     */
    public static function getTree(?string $type = null, ?int $maxDepth = null, ?string $locale = null): Collection
    {
        $query = static::query();
    ...
    /**
     * Get projects in this category (and optionally descendants)
     */
    public function projects(bool $includeDescendants = false): BelongsToMany
    {
        $query = $this->belongsToMany(\Modules\Polyx\ProjectHub\Models\Project::class, 'project_category');
