...
class UpdatePostRequest extends FormRequest
{
    ...
    {
        $postModel = $this->route('post');
        $id = $postModel instanceof \Illuminate\Database\Eloquent\Model ? $postModel->id : $postModel;
        $locale = $this->input('locale', $postModel instanceof \Illuminate\Database\Eloquent\Model ? $postModel->locale : 'en');
        ...
        $rules = [
            ...
            'slug' => [
                ...
                'string',
                'max:255',
                Rule::unique('posts', 'slug')->where('locale', $locale)->whereNull('deleted_at')->ignore($id)
            ],
