...
class CartApiController extends Controller
{
    ...
    public function addItem(Request $request): JsonResponse
    {
        $validated = $request->validate([
            ...
            'service_id' => 'nullable|integer|exists:product_services,id',
        ...
        try {
            ...
            if (isset($validated['service_id'])) {
                $metadata['service_id'] = $validated['service_id'] !== null ? (int) $validated['service_id'] : null;
            }
    ...
    public function updateItem(Request $request, int $itemId): JsonResponse
    {
        ...
        try {
            ...
            $this->cartService->updateItem(
                ...
                $request->has('service_id') ? $validated['service_id'] : 'ignore'
            );

            // Force reload items relation to capture the updated service_id
