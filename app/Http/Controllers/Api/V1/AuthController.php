...
class AuthController extends Controller
{
    ...
    public function login(Request $request): JsonResponse
    {
        ...
        $canAccessAdmin = Hook::applyFilters('auth.can_access_admin', $canAccessAdmin, $user, $request);
        ...
        $hookResponse = Hook::applyFilters('auth.login.pre_token', null, $user, $request);
        ...
        Hook::doAction('auth.login.succeeded', $user, $request, $token);
        Hook::doAction('user.login', $user, $request, 'api');
