...
class UploadController extends Controller
{
    ...
    public function image(Request $request): JsonResponse
    {
        $validated = $request->validate([
            'image' => ['required', 'image', 'mimes:jpeg,png,jpg,gif,svg,webp', 'max:10240'], // 10MB max, strict mimes
        ]);
        ...
        // Security Fix: Use extension() instead of getClientOriginalExtension() to prevent fake image extensions (like .php)
