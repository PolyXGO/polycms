...
class ProductAttributeController extends Controller
{
    ...
    public function show(Request $request, ProductAttribute $attribute): JsonResponse
    {
        return response()->json([
            'success' => true,
            'data' => $attribute->load(['values', 'group']),
    ...
    public function destroy(Request $request, ProductAttribute $attribute): JsonResponse
    {
    ...
    public function destroyValue(Request $request, ProductAttribute $attribute, ProductAttributeValue $value): JsonResponse
    {
        $this->authorizePermission($request, 'update product');
