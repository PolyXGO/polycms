...
<template>
    <section class="space-y-6 text-gray-900 dark:text-gray-100 transition-colors">
        <header>
        ...
        <Modal :show="confirmingUserDeletion" @close="closeModal" maxWidth="xl" center>
            <div class="p-6 bg-white dark:bg-gray-900 border border-transparent dark:border-gray-800 transition-colors">
                <h2
