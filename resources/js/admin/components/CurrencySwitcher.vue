<template>
 ...
 :class="{'active-item': currentCode === currency.code}"
 >
 <span class="flex items-center gap-2">
 <span>{{ currency.code }} - {{ currency.symbol }}</span>
 </span>
 <svg v-if="currentCode === currency.code" class="w-4 h-4 check-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
