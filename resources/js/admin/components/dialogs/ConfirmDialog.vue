            ...
            >
                ...
                <div class="flex min-h-full items-center justify-center p-4">
                    ...
                    >
                        ...
                        <!-- Body -->
                        <div class="px-6 py-4">
                            <div class="text-sm text-gray-600 dark:text-gray-400 whitespace-pre-line" v-html="dialogStore.confirmDialog.message"></div>
                        </div>
...
const buttonClass = computed(() => {
    ...
    return types[dialogStore.confirmDialog.type] || 'bg-indigo-600 hover:bg-indigo-700 text-white';
});
</script>
