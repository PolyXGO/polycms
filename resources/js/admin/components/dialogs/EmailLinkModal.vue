<template>
 ...
 ref="relTriggerRef"
 type="button"
 class="w-full px-3 py-2 border border-admin-theme-border rounded-lg bg-admin-theme-input-bg text-left text-admin-theme-text flex items-center justify-between"
 ...
 ref="relMenuRef"
 class="fixed z-[1000001] rounded-lg border border-admin-theme-border bg-admin-theme-surface shadow-lg overflow-hidden"
 :style="dropdownStyle"
 >
 <button
 ...
 :key="option.value"
 type="button"
 class="w-full px-3 py-2 text-left hover:bg-admin-theme-base border-b last:border-b-0 border-admin-theme-border"
