<template>
 ...
 <div class="border border-admin-theme-border rounded-lg bg-admin-theme-input-bg overflow-hidden">
 <!-- Toolbar -->
 <div class="border-b border-admin-theme-border bg-admin-theme-base p-2 flex flex-wrap items-center gap-1">
 <!-- Undo/Redo -->
 <button
 type="button"
 ...
 :class="['px-2 py-1 rounded text-sm font-medium', editor?.isActive('heading', { level: 1 }) ?'bg-admin-theme-primary text-admin-theme-primary-content' :'bg-admin-theme-input-bg text-admin-theme-text-secondary hover:bg-admin-theme-base']"
 >H1</button>
 <button
 type="button"
 @click="editor?.chain().focus().toggleHeading({ level: 2 }).run()"
 :class="['px-2 py-1 rounded text-sm font-medium', editor?.isActive('heading', { level: 2 }) ?'bg-admin-theme-primary text-admin-theme-primary-content' :'bg-admin-theme-input-bg text-admin-theme-text-secondary hover:bg-admin-theme-base']"
 >H2</button>
 <button
 type="button"
 @click="editor?.chain().focus().setParagraph().run()"
 :class="['px-2 py-1 rounded text-sm font-medium', editor?.isActive('paragraph') ?'bg-admin-theme-primary text-admin-theme-primary-content' :'bg-admin-theme-input-bg text-admin-theme-text-secondary hover:bg-admin-theme-base']"
 >P</button>
 ...
 :class="['px-2 py-1 rounded text-sm font-medium', editor?.isActive('bold') ?'bg-admin-theme-primary text-admin-theme-primary-content' :'bg-admin-theme-input-bg text-admin-theme-text-secondary hover:bg-admin-theme-base']"
 >B</button>
 <button
 type="button"
 @click="editor?.chain().focus().toggleItalic().run()"
 :class="['px-2 py-1 rounded text-sm font-medium', editor?.isActive('italic') ?'bg-admin-theme-primary text-admin-theme-primary-content' :'bg-admin-theme-input-bg text-admin-theme-text-secondary hover:bg-admin-theme-base']"
 >I</button>
 <button
 type="button"
 @click="editor?.chain().focus().toggleUnderline().run()"
 :class="['px-2 py-1 rounded text-sm font-medium', editor?.isActive('underline') ?'bg-admin-theme-primary text-admin-theme-primary-content' :'bg-admin-theme-input-bg text-admin-theme-text-secondary hover:bg-admin-theme-base']"
 >U</button>
 ...
 :class="['px-2 py-1 rounded text-sm font-medium', editor?.isActive('bulletList') ?'bg-admin-theme-primary text-admin-theme-primary-content' :'bg-admin-theme-input-bg text-admin-theme-text-secondary hover:bg-admin-theme-base']"
 >
 <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
 ...
 :class="['px-2 py-1 rounded text-sm font-medium', editor?.isActive('orderedList') ?'bg-admin-theme-primary text-admin-theme-primary-content' :'bg-admin-theme-input-bg text-admin-theme-text-secondary hover:bg-admin-theme-base']"
 >
 <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
 ...
 :class="['px-2 py-1 rounded text-sm font-medium', editor?.isActive({ textAlign:'left' }) ?'bg-admin-theme-primary text-admin-theme-primary-content' :'bg-admin-theme-input-bg text-admin-theme-text-secondary hover:bg-admin-theme-base']"
 >
 <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
 ...
 :class="['px-2 py-1 rounded text-sm font-medium', editor?.isActive({ textAlign:'center' }) ?'bg-admin-theme-primary text-admin-theme-primary-content' :'bg-admin-theme-input-bg text-admin-theme-text-secondary hover:bg-admin-theme-base']"
 >
 <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
 ...
 type="button"
 @click="setLink"
 :class="['px-2 py-1 rounded text-sm font-medium', editor?.isActive('link') ?'bg-admin-theme-primary text-admin-theme-primary-content' :'bg-admin-theme-input-bg text-admin-theme-text-secondary hover:bg-admin-theme-base']"
 >
 <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
 ...
 class="px-2 py-1 rounded text-sm font-medium transition-colors bg-admin-theme-input-bg text-admin-theme-text-secondary hover:bg-admin-theme-base flex items-center gap-1"
 >
 <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
 ...
 <div class="ml-auto flex items-center border border-admin-theme-border rounded-lg overflow-hidden">
 <button
 type="button"
 @click="setVisualMode"
 :class="[
...
'px-3 py-1 text-xs font-mono transition-colors border-l border-admin-theme-border',
 ...
 v-else
 v-model="htmlSource"
 class="w-full min-h-[300px] p-4 border-0 bg-admin-theme-input-bg text-admin-theme-text font-mono text-sm leading-6 focus:outline-none resize-y"
...
const editor = useEditor({
 ...
 editorProps: {
 attributes: {
 class:'prose prose-sm max-w-none dark:prose-invert text-admin-theme-text focus:outline-none min-h-[300px] p-4',
 },
...
.email-tiptap-editor .ProseMirror a:hover {
 color: rgb(var(--admin-theme-primary-hover));
}
...
.dark .email-tiptap-editor .ProseMirror a:hover {
 color: rgb(var(--admin-theme-primary) / 0.7);
}
</style>
