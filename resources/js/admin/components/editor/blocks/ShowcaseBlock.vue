<template>
 ...
 :key="index"
 class="p-3 bg-admin-theme-base rounded-lg border border-admin-theme-border mb-2 relative group"
 >
 <button
 type="button"
 ...
 v-model="step.title"
 type="text"
 class="w-full bg-admin-theme-surface border-admin-theme-border rounded p-1 text-xs font-bold"
 placeholder="Step Title"
 >
 <textarea
 v-model="step.text"
 class="w-full bg-admin-theme-surface border-admin-theme-border rounded p-1 text-[10px] h-10"
 ...
 type="button"
 @click="addStep"
 class="w-full py-1 border border-dashed border-admin-theme-border rounded text-[10px] text-gray-500 hover:text-admin-theme-primary hover:border-admin-theme-primary"
 >
 + Add Step
 </button>
 </div>
 ...
 type="text"
 class="flex-1 bg-admin-theme-base border-admin-theme-border rounded-lg p-2 text-xs"
 placeholder="Pick from Media or paste an image URL..."
 >
 <button
 type="button"
 class="px-3 py-2 bg-admin-theme-base rounded-lg text-xs hover:bg-admin-theme-base"
 @click="openMediaPicker"
 >
 Pick
 </button>
 </div>
 <p class="mt-2 text-[11px] leading-5 text-admin-theme-text-muted">
 ...
 type="text"
 class="w-full bg-admin-theme-base border-admin-theme-border rounded-lg p-2 text-xs"
 ...
 type="text"
 class="bg-admin-theme-base border-admin-theme-border rounded-lg p-2 text-xs"
 placeholder="Text"
 >
 <input
 ...
 <div class="rounded-xl border border-dashed border-admin-theme-border bg-admin-theme-base/80 px-4 py-3 text-[11px] leading-5 text-admin-theme-text-muted dark:text-admin-theme-text-muted">
...
.showcase-block__swap:hover {
 border-color: rgb(var(--admin-theme-primary) / 0.4);
