<template>
 ...
 <textarea v-model="state.content" class="w-full bg-admin-theme-base border-admin-theme-border rounded-lg p-2 text-sm h-32 focus:ring-2 focus:ring-admin-theme-primary" placeholder="Enter text content..."></textarea>
 </div>

 <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
 <div class="form-group">
 <label class="block text-[10px] font-bold uppercase tracking-wider text-gray-400 mb-2">Font Size</label>
 <select v-model="state.font_size" class="w-full bg-admin-theme-base border-admin-theme-border rounded-lg px-3 py-2 text-sm h-11">
