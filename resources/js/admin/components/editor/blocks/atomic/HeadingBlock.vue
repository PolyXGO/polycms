<template>
 ...
 <textarea v-model="state.text" class="w-full bg-admin-theme-base border-admin-theme-border rounded-lg p-2 text-sm h-20 focus:ring-2 focus:ring-admin-theme-primary" placeholder="Enter heading..."></textarea>
 </div>

 <div class="grid grid-cols-2 gap-4">
 <div class="form-group">
 <label class="block text-[10px] font-bold uppercase tracking-wider text-gray-400 mb-2">Level</label>
 <select v-model="state.level" class="w-full bg-admin-theme-base border-admin-theme-border rounded-lg p-2 text-xs">
 ...
 <select v-model="state.font_weight" class="w-full bg-admin-theme-base border-admin-theme-border rounded-lg p-2 text-xs">
 ...
 <input v-model="state.color" type="text" class="flex-1 bg-admin-theme-base border-admin-theme-border rounded-lg p-1 text-xs" placeholder="#000000">
 </div>
 </div>
 </div>
