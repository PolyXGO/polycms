<template>
 ...
 :style="sliderStyle"
 >
 <span class="inline-flex min-w-[3rem] items-center justify-center rounded-full bg-admin-theme-primary/10 px-2 py-0.5 text-[11px] font-bold text-admin-theme-primary dark:bg-admin-theme-primary/100/10">{{ state.height }}px</span>
 </div>
 </div>
 </div>

 <!-- Preview Mode -->
 <div v-else class="spacer-block-preview flex items-center justify-center bg-admin-theme-base/50 border border-dashed border-admin-theme-border/50 rounded-lg" :style="{ height: state.height +'px' }">
