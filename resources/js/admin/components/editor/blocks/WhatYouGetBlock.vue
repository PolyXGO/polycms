<template>
 ...
 class="w-full bg-admin-theme-base border-admin-theme-border rounded-lg p-2 text-sm h-20 focus:ring-2 focus:ring-admin-theme-primary"
 ...
 type="text" 
 class="flex-1 bg-admin-theme-base border-admin-theme-border rounded-lg p-2 text-sm focus:ring-2 focus:ring-admin-theme-primary"
 ...
 <div class="form-group p-3 bg-admin-theme-base rounded-lg border border-admin-theme-border">
 <label class="flex items-center gap-2 cursor-pointer">
 <input type="checkbox" v-model="state.show_highlight" class="rounded text-admin-theme-primary focus:ring-admin-theme-primary">
 <span class="text-xs font-bold uppercase tracking-wider text-admin-theme-text-secondary">Show Subscription Highlight</span>
 </label>
 <div v-if="state.show_highlight" class="mt-3 space-y-3">
 <input 
 v-model="state.highlight_title" 
 type="text" 
 class="w-full bg-admin-theme-surface border-admin-theme-border rounded-lg p-2 text-sm focus:ring-2 focus:ring-admin-theme-primary"
 placeholder="Highlight Title"
 >
 <textarea 
 v-model="state.highlight_text" 
 class="w-full bg-admin-theme-surface border-admin-theme-border rounded-lg p-2 text-sm h-16 focus:ring-2 focus:ring-admin-theme-primary"
...
.what-you-get-block-preview__button {
 ...
 min-height: 2.9rem;
 padding: 0 1.4rem;
 border: 1px solid rgb(var(--admin-theme-primary) / 0.4);
