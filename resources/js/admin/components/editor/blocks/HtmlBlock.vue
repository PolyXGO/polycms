<template>
 <div class="html-block-editor p-6 bg-admin-theme-surface rounded-lg border border-admin-theme-border">
 ...
 <input type="checkbox" v-model="state.wrap_raw" class="form-checkbox h-3 w-3 text-admin-theme-primary">
 <span class="text-xs text-gray-500">Wrap Raw (no container)</span>
 </label>
 </div>
 <textarea 
 v-model="state.html" 
 class="w-full bg-gray-900 border-gray-700 rounded-lg p-4 text-xs font-mono text-green-400 h-64 focus:ring-1 focus:ring-admin-theme-primary outline-none"
