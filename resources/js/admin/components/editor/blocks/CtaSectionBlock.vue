<template>
 ...
 <input v-model="state.heading" type="text" class="w-full bg-admin-theme-base border-admin-theme-border rounded-lg p-2 text-sm focus:ring-2 focus:ring-admin-theme-primary" placeholder="Ready to Launch?">
 </div>
 
 <div class="form-group">
 <label class="block text-[10px] font-bold uppercase tracking-wider text-gray-400 mb-2">Main Text</label>
 <textarea v-model="state.text" class="w-full bg-admin-theme-base border-admin-theme-border rounded-lg p-2 text-sm h-20 focus:ring-2 focus:ring-admin-theme-primary" placeholder="Main description text..."></textarea>
 </div>

 <div class="form-group">
 <label class="block text-[10px] font-bold uppercase tracking-wider text-gray-400 mb-2">Small Info Text</label>
 <input v-model="state.info_text" type="text" class="w-full bg-admin-theme-base border-admin-theme-border rounded-lg p-2 text-sm focus:ring-2 focus:ring-admin-theme-primary" placeholder="Fill the form below...">
 </div>

 <div class="form-group">
 <label class="block text-[10px] font-bold uppercase tracking-wider text-gray-400 mb-2">Form HTML / Shortcode</label>
 <textarea v-model="state.form_html" class="w-full bg-admin-theme-base border-admin-theme-border rounded-lg p-2 text-xs h-20 font-mono" placeholder="<iframe>...</iframe> or [form-id=1]"></textarea>
 </div>
 ...
 <input v-model="stat.number" type="text" class="w-20 bg-admin-theme-base border-admin-theme-border rounded p-1 text-xs font-bold" placeholder="10+">
 <input v-model="stat.label" type="text" class="flex-1 bg-admin-theme-base border-admin-theme-border rounded p-1 text-xs" placeholder="Successful Launches">
 ...
 <button @click="addStat" class="w-full py-1 border border-dashed border-admin-theme-border rounded text-[10px] text-gray-500 hover:text-admin-theme-primary hover:border-admin-theme-primary">+ Add Stat</button>
 </div>
 </div>
