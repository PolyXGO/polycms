<template>
 ...
 <input v-model="stat.value" type="text" class="w-20 bg-admin-theme-base border-admin-theme-border rounded p-1 text-xs font-bold" placeholder="99.9%">
 <input v-model="stat.label" type="text" class="flex-1 bg-admin-theme-base border-admin-theme-border rounded p-1 text-xs" placeholder="Uptime">
