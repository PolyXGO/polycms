<template>
 <div class="gallery-block-editor p-6 bg-admin-theme-surface rounded-lg border border-admin-theme-border" :style="{ padding: state.padding }">
 ...
 <select v-model.number="state.columns" class="w-full bg-admin-theme-base border-admin-theme-border rounded-lg p-2 text-xs">
 ...
 <select v-model="state.gap" class="w-full bg-admin-theme-base border-admin-theme-border rounded-lg p-2 text-xs">
 ...
 <select v-model="state.rounded" class="w-full bg-admin-theme-base border-admin-theme-border rounded-lg p-2 text-xs">
 ...
 <button @click="openMediaPicker" class="px-3 py-1.5 bg-admin-theme-primary text-admin-theme-primary-content rounded-lg text-xs font-bold hover:bg-admin-theme-primary-hover transition-colors flex items-center gap-1">
 ...
 >
 <div v-for="(element, index) in state.images" :key="index" class="relative group aspect-square rounded-lg overflow-hidden border border-admin-theme-border bg-admin-theme-base">
 ...
 <div v-else class="p-10 text-center border-2 border-dashed border-admin-theme-border rounded-xl">
