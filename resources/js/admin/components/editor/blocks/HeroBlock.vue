...
watch(() => props.modelValue, (newValue) => {
  if (props.mode === 'preview' && newValue) {
    ...
    state.button_text = newValue.button_text || '';
    state.button_link = newValue.button_link || '';
    state.secondary_button_text = newValue.secondary_button_text || '';
    state.secondary_button_link = newValue.secondary_button_link || '';
