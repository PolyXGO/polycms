<template>
 ...
 type="text" 
 class="w-full bg-admin-theme-base border-admin-theme-border rounded-lg p-2 text-sm"
 ...
 class="w-full bg-admin-theme-base border-admin-theme-border rounded-lg p-2 text-sm h-24"
 ...
 >
 <button @click="openMediaPicker" class="px-3 py-2 bg-admin-theme-primary text-admin-theme-primary-content rounded-lg text-xs hover:bg-admin-theme-primary-hover">
 Pick
 </button>
 </div>
 </div>
 ...
 :class="state.image_position ==='left' ?'bg-admin-theme-primary text-admin-theme-primary-content border-admin-theme-primary' :'bg-admin-theme-input-bg border-admin-theme-border'"
 >
 Left
 </button>
 <button 
 ...
 class="flex-1 px-3 py-2 text-xs rounded-lg border transition-all"
 :class="state.image_position ==='right' ?'bg-admin-theme-primary text-admin-theme-primary-content border-admin-theme-primary' :'bg-admin-theme-input-bg border-admin-theme-border'"
 >
 Right
 </button>
 </div>
