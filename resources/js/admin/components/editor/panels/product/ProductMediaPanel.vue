<template>
 ...
 <h3 class="text-sm font-semibold text-admin-theme-text uppercase tracking-wider">{{ $t('Featured Image') }}</h3>
 </header>
 <div class="space-y-4">
 <div
 ...
 <span class="text-sm text-admin-theme-text-muted">{{ $t('Choose image') }}</span>
 </template>
 </div>
 </div>
 </section>
 ...
 <p v-else class="text-sm text-admin-theme-text-muted italic">{{ $t('No gallery images yet.') }}</p>
 </section>
 </div>
</template>
