<template>
 ...
 <div class="flex items-center justify-between">
 <div class="flex items-center gap-2">
 <span class="text-sm font-semibold text-admin-theme-text-secondary">Content Type:</span>
 <strong class="text-sm text-admin-theme-text">{{ typeLabel }}</strong>
 </div>
 </div>
 </div>
 ...
 <div class="flex items-center justify-between">
 <div class="flex items-center gap-2">
 <span class="text-sm font-semibold text-admin-theme-text-secondary">Publish Date:</span>
 ...
 <button type="button" class="px-4 py-2 border border-admin-theme-border bg-admin-theme-input-bg text-admin-theme-text rounded-lg font-semibold hover:bg-black/5 dark:hover:bg-white/5 transition-colors text-sm" @click="helpers.preview?.()">
 Preview Changes
 </button>
 <button
 type="button"
