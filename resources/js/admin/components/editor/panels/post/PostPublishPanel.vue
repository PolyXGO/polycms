<template>
    <div v-if="form" class="publish-panel">
        ...
        <div class="publish-panel__group" v-if="typeOptions && typeOptions.length">
            <div class="publish-panel__row">
                <div class="publish-panel__pair">
                    <span class="publish-panel__meta-label">Content Type:</span>
                    <strong class="publish-panel__meta-value">{{ typeLabel }}</strong>
                </div>
            </div>
        </div>
...
const statusLabel = computed(() => {
    const current = statusOptions.value.find((option) => option.value === form.value.status);
