<template>
 ...
 <section class="space-y-3 rounded-xl border border-slate-200 bg-admin-theme-base p-4 dark:border-slate-700 dark:bg-slate-900/40">
 <h3 class="text-sm font-semibold uppercase tracking-wide text-slate-700 dark:text-slate-200">SEO Metadata</h3>

 <div class="space-y-1">
 <label class="block text-sm font-medium text-admin-theme-text-secondary">Meta Title</label>
 <input
 v-model="form.meta_title"
 type="text"
 class="w-full rounded-lg border border-admin-theme-border bg-admin-theme-base px-3 py-2 text-admin-theme-text placeholder-gray-400 focus:border-admin-theme-primary focus:ring-admin-theme-primary border-admin-theme-input-border"
 placeholder="Title shown in search results"
 />
 <p class="text-xs text-admin-theme-text-muted">{{ titleLength }} / 60</p>
 </div>

 <div class="space-y-1">
 <label class="block text-sm font-medium text-admin-theme-text-secondary">Meta Description</label>
 <textarea
 v-model="form.meta_description"
 rows="3"
 class="min-h-[110px] w-full resize-vertical rounded-lg border border-admin-theme-border bg-admin-theme-base px-3 py-2 text-admin-theme-text placeholder-gray-400 focus:border-admin-theme-primary focus:ring-admin-theme-primary border-admin-theme-input-border"
 placeholder="Short description for SEO"
 />
 <p class="text-xs text-admin-theme-text-muted">{{ descriptionLength }} / 160</p>
 </div>

 <div class="space-y-1">
 <label class="block text-sm font-medium text-admin-theme-text-secondary">Meta Keywords</label>
 <input
 ...
 <div class="space-y-1">
 <label class="block text-sm font-medium text-admin-theme-text-secondary">Canonical URL</label>
 <input
 ...
 <div class="space-y-1">
 <label class="block text-sm font-medium text-admin-theme-text-secondary">Robots Meta</label>
 <select
 v-model="robotsMeta"
 class="w-full rounded-lg border border-admin-theme-border bg-admin-theme-base px-3 py-2 text-admin-theme-text focus:border-admin-theme-primary focus:ring-admin-theme-primary border-admin-theme-input-border"
 >
 ...
 <p class="text-xs text-admin-theme-text-muted">Override the default robots directive for this post.</p>
 </div>
 ...
 <div class="grid gap-3 md:grid-cols-2">
 <div class="space-y-1">
 <label class="block text-sm font-medium text-admin-theme-text-secondary">Focus Keyword</label>
 <input
 ...
 <div class="space-y-1">
 <label class="block text-sm font-medium text-admin-theme-text-secondary">Primary Category</label>
 <select
 ...
 <label class="block text-sm font-medium text-admin-theme-text-secondary">Social Title</label>
 <input
 v-model="socialTitle"
 type="text"
 class="w-full rounded-lg border border-admin-theme-border bg-admin-theme-base px-3 py-2 text-admin-theme-text placeholder-gray-400 focus:border-admin-theme-primary focus:ring-admin-theme-primary border-admin-theme-input-border"
 ...
 <div class="space-y-1 md:col-span-1">
 <label class="block text-sm font-medium text-admin-theme-text-secondary">Social Description</label>
 <input
 ...
 <div class="space-y-1 md:col-span-1">
 <label class="block text-sm font-medium text-admin-theme-text-secondary">Social Image URL</label>
 <input
 v-model="socialImage"
 type="url"
 class="w-full rounded-lg border border-admin-theme-border bg-admin-theme-base px-3 py-2 text-admin-theme-text placeholder-gray-400 focus:border-admin-theme-primary focus:ring-admin-theme-primary border-admin-theme-input-border"
 ...
 <span class="rounded-full bg-admin-theme-primary/10 px-3 py-1 text-xs font-semibold text-blue-700 dark:bg-blue-900/30 dark:text-blue-200">
 ...
 <div class="space-y-3">
 <div class="rounded-lg border border-slate-200 bg-admin-theme-base p-3 dark:border-slate-700 dark:bg-slate-900">
 ...
 <div class="grid gap-3 md:grid-cols-2">
 <div class="overflow-hidden rounded-lg border border-slate-200 bg-admin-theme-base dark:border-slate-700 dark:bg-slate-900">
