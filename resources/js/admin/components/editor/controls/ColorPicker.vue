<template>
 ...
 <div class="flex min-w-0 flex-1 items-center gap-3 rounded-lg border border-admin-theme-border bg-admin-theme-base px-3 py-2 shadow-sm">
 <span class="truncate text-sm font-medium text-admin-theme-text-secondary">{{ displayValue }}</span>
 <button
 v-if="hasValue"
 type="button"
 class="ml-auto inline-flex items-center justify-center rounded-md border border-admin-theme-border bg-admin-theme-surface px-2.5 py-1 text-[11px] font-semibold text-admin-theme-text-secondary transition-colors hover:border-red-200 hover:bg-red-50 hover:text-red-600 dark:hover:border-red-500/40 dark:hover:bg-red-500/10 dark:hover:text-red-300"
 @click="clearColor"
 >
 Clear
 </button>
 <span v-else class="ml-auto text-[11px] font-semibold uppercase tracking-[0.14em] text-admin-theme-text-muted">Default</span>
 </div>
 </div>
