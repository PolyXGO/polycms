<template>
 ...
 <span class="inline-flex min-w-[3rem] items-center justify-center rounded-full bg-admin-theme-primary/10 px-2 py-0.5 text-[11px] font-bold text-admin-theme-primary dark:bg-admin-theme-primary/100/10">{{ modelValue }}{{ unit }}</span>
 </div>
