      ...
      >
        ...
        <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
          <tr 
            ...
            :class="[
                draggingIndex === index ? 'opacity-40 border-2 border-dashed border-indigo-400 dark:border-indigo-500 scale-[0.98]' : '',
                dragOverIndex === index ? 'bg-indigo-50 dark:bg-indigo-900/20 border-indigo-200' : ''
            ]"
            draggable="true"
