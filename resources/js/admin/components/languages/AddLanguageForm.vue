<template>
 ...
 <h3 class="text-lg font-medium text-admin-theme-text mb-4">{{ t('Add Language') }}</h3>
 
 <form @submit.prevent="submit">
 <!-- Language Selector with Search -->
 <div class="mb-4">
 <label class="block text-sm font-medium text-admin-theme-text-secondary mb-1">{{ t('Select Language') }}</label>
 <LanguageSelector 
 ...
 <button 
 type="submit" 
 class="w-full inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-admin-theme-primary-content bg-admin-theme-primary hover:bg-admin-theme-primary-hover focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-admin-theme-primary disabled:opacity-50"
 :disabled="loading"
 >
 ...
 <div class="mt-8 pt-6 border-t border-admin-theme-border">
 <div class="p-4 bg-admin-theme-primary/10 border border-indigo-100 dark:border-indigo-900/30 rounded-md text-xs text-admin-theme-primary-hover dark:text-admin-theme-primary">
 <div class="flex">
