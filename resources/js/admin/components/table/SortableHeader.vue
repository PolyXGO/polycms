...
'select-none group whitespace-nowrap',
 ...
 sortKey ?'cursor-pointer hover:text-admin-theme-primary transition-colors duration-150' :'',
 isActive ?'text-admin-theme-primary' :'text-admin-theme-text-muted',
 ]"
 :aria-sort="ariaSort"
 role="columnheader"
 ...
 <svg :class="['w-3 h-3 -mb-0.5', currentDir ==='asc' && isActive ?'text-admin-theme-primary' :'text-gray-400']" viewBox="0 0 16 16" fill="currentColor">
 <path d="M8 4l4 5H4l4-5z"/>
 </svg>
 <svg :class="['w-3 h-3 -mt-0.5', currentDir ==='desc' && isActive ?'text-admin-theme-primary' :'text-gray-400']" viewBox="0 0 16 16" fill="currentColor">
