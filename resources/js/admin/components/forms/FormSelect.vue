...
const selectClasses = computed(() => {
 const baseClasses ='w-full px-3 py-2 border rounded-lg bg-admin-theme-input-bg text-admin-theme-text transition-all duration-200 appearance-none';
 ...
 return `${baseClasses} border-admin-theme-border focus:border-admin-theme-primary focus:ring-admin-theme-primary`;
});
