<template>
 ...
 class="absolute right-3 top-1/2 transform -translate-y-1/2 text-admin-theme-text-muted hover:text-gray-700 dark:hover:text-gray-300 focus:outline-none"
...
const inputClasses = computed(() => {
 const baseClasses = 'w-full px-3 py-2 border rounded-lg bg-admin-theme-input-bg text-admin-theme-text text-base sm:text-sm transition-all duration-200';
 ...
 return `${baseClasses} ${paddingRight} border-admin-theme-border focus:border-admin-theme-primary focus:ring-admin-theme-primary`;
});
