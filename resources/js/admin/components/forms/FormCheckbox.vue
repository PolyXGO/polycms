<template>
 ...
 v-if="label"
 :for="checkboxId"
 class="ml-2 text-sm font-medium text-admin-theme-text-secondary"
 >
 {{ label }}
...
const checkboxClasses = computed(() => {
 const baseClasses ='w-4 h-4 text-admin-theme-primary rounded focus:ring-admin-theme-primary border-admin-theme-input-border bg-admin-theme-input-bg transition-all duration-200';
