<template>
 ...
 <svg class="animate-spin h-5 w-5 text-admin-theme-primary" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
...
.command-palette__input::placeholder { color: rgb(var(--admin-theme-text-secondary)); }
...
.command-palette__item-icon--order { background: rgba(99, 102, 241, 0.15); color: rgb(var(--admin-theme-primary)); }
