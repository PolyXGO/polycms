<template>
 ...
 <p class="mt-2 text-admin-theme-text-secondary">{{ $t('Loading profile...') }}</p>
 </div>

 <div v-else class="space-y-6">
 <!-- Profile Information -->
 <div class="bg-admin-theme-surface rounded-lg shadow p-6">
 <h2 class="text-lg font-semibold text-admin-theme-text mb-4">
 ...
 <div class="p-4 bg-admin-theme-base rounded-lg flex items-center justify-between">
 <div class="flex items-center">
 <svg class="h-5 w-5 text-admin-theme-primary dark:text-admin-theme-primary mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
 <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 7a2 2 0 012 2m4 0a6 6 0 01-7.743 5.743L11 17H9v2H7v2H4a1 1 0 01-1-1v-2.586a1 1 0 01.293-.707l5.964-5.964A6 6 0 1121 9z" />
 </svg>
 <span class="text-sm font-medium text-admin-theme-text-secondary">{{ $t('Recovery Codes') }}</span>
 </div>
 <button
 @click="fetchRecoveryCodes"
 class="text-sm text-admin-theme-primary dark:text-admin-theme-primary hover:text-admin-theme-primary-hover font-medium"
 >
 {{ $t('View Codes') }}
 </button>
 </div>
 ...
 <div v-if="!show2FASetup" class="p-4 bg-admin-theme-base text-admin-theme-text-secondary rounded-lg flex items-start">
 <svg class="h-5 w-5 mr-3 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
 ...
 <div v-if="show2FASetup" class="space-y-6 p-4 border border-admin-theme-border rounded-lg">
 ...
 <code class="px-2 py-1 bg-admin-theme-base rounded text-admin-theme-primary dark:text-admin-theme-primary font-mono">{{ twoFactorSecret }}</code>
 </div>
 </div>
 ...
 class="px-4 py-2 text-admin-theme-text-secondary hover:bg-admin-theme-base rounded-lg transition-colors"
 >
 {{ $t('Cancel') }}
 </button>
 <button
 ...
 class="px-4 py-2 bg-admin-theme-primary text-admin-theme-primary-content rounded-lg hover:bg-admin-theme-primary-hover disabled:opacity-50 transition-colors"
 >
 ...
 <div class="bg-admin-theme-surface rounded-xl shadow-2xl max-w-md w-full p-6 space-y-4">
 <h3 class="text-xl font-bold text-admin-theme-text">
 {{ $t('Disable Two-Factor Authentication') }}
 </h3>
 <p class="text-admin-theme-text-secondary">
 ...
 <div class="bg-admin-theme-surface rounded-xl shadow-2xl max-w-lg w-full p-6 space-y-6">
 <div class="flex items-center justify-between">
 <h3 class="text-xl font-bold text-admin-theme-text">
 {{ $t('Two-Factor Recovery Codes') }}
 </h3>
 <button @click="showRecoveryCodesModal = false" class="text-gray-400 hover:text-gray-600">
 ...
 <div class="grid grid-cols-2 gap-3 p-4 bg-admin-theme-base rounded-lg border border-admin-theme-border font-mono text-sm">
 <div v-for="code in recoveryCodes" :key="code" class="flex items-center text-admin-theme-text-secondary">
 <span class="mr-2 text-admin-theme-primary">•</span>
 {{ code }}
 </div>
 </div>
 ...
 class="px-6 py-2 bg-admin-theme-primary text-admin-theme-primary-content rounded-lg hover:bg-admin-theme-primary-hover transition-colors font-medium"
 >
