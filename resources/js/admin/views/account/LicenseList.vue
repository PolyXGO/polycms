<template>
 ...
 <h1 class="text-2xl font-bold text-admin-theme-text">{{ t('My Licenses') }}</h1>
 </div>
 ...
 <td class="px-6 py-4 whitespace-nowrap text-sm text-admin-theme-text font-mono bg-admin-theme-base rounded p-1">
 {{ license.license_key }}
 </td>
 ...
 <button class="text-admin-theme-primary dark:text-admin-theme-primary hover:text-admin-theme-primary dark:hover:text-admin-theme-primary">
 {{ t('Manage') }}
 </button>
 </td>
 </tr>
