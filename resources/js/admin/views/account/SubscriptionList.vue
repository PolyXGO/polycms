<template>
 ...
 <h1 class="text-2xl font-bold text-admin-theme-text">{{ t('My Subscriptions') }}</h1>
 </div>
 ...
 <tr>
 <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">{{ t('Product/Service') }}</th>
 ...
 {{ formatCurrency(sub.paid_price !== undefined && sub.paid_price !== null ? sub.paid_price : (sub.recurring_price || sub.product?.price || sub.service?.price), sub.currency) }}
 </td>
