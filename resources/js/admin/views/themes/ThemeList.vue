    ...
    <div>
        ...
        >
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-xl max-w-lg w-full m-4">
                <div class="p-6">
                    <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-1">Set as Main Theme</h3>
                    <p class="text-sm text-gray-500 dark:text-gray-400 mb-4">
                        You are switching the Main Theme to <strong class="text-gray-900 dark:text-white">{{ setMainTarget?.name }}</strong>.
                    </p>
                    ...
                    <div v-if="snapshotInfo?.has_snapshot" class="space-y-3 mb-4">
                        ...
                        >
                            <input type="radio" v-model="restoreMode" value="restore" class="mt-1 text-indigo-600" />
                            <div>
                                <div class="text-sm font-medium text-gray-900 dark:text-white">Restore previous homepage</div>
                        ...
                        <label class="flex items-start gap-3 p-3 border rounded-lg cursor-pointer transition-colors"
                            :class="restoreMode === 'reset'
                                ...
                                : 'border-gray-200 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-700/50'"
                        >
                            <input type="radio" v-model="restoreMode" value="reset" class="mt-1 text-indigo-600" />
                            <div>
                                <div class="text-sm font-medium text-gray-900 dark:text-white">Reset to default</div>
                                <div class="text-xs text-gray-500 dark:text-gray-400 mt-0.5">
