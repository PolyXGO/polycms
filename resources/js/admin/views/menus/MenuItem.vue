...
'menu-item min-w-0',
 ...
 ref="itemBar"
 :class="[
'flex items-center gap-3 p-3 rounded-lg hover:bg-black/5 dark:hover:bg-white/5 border border-admin-theme-border bg-admin-theme-surface transition-colors min-w-0',
 dragOverId === item.id && dragOverPosition ==='inside' ?'ring-2 ring-indigo-400 ring-offset-2 bg-admin-theme-primary/10 border-indigo-300 dark:border-admin-theme-primary' :'',
 ]"
 :style="{ marginLeft: `${level * 24}px` }"
 >
 <!-- Drag Handle -->
 <div class="cursor-move text-admin-theme-text-muted flex-shrink-0">
 ...
 class="text-admin-theme-text-muted hover:text-gray-600 dark:hover:text-gray-300 flex-shrink-0"
 >
 <svg
 ...
 <div class="text-sm font-medium text-admin-theme-text truncate">
 {{ item.title }}
 </div>
 <div v-if="item.url" class="text-xs text-admin-theme-text-muted mt-1 truncate">
 {{ displayUrl }}
 </div>
 </div>
 ...
 <!-- <span class="text-xs text-admin-theme-text-muted whitespace-nowrap">
 ...
 class="p-1 text-admin-theme-text-muted hover:text-admin-theme-primary dark:hover:text-admin-theme-primary"
 :title="$t('Edit')"
 >
 ...
 class="p-1 text-admin-theme-text-muted hover:text-red-600 dark:hover:text-red-400"
 :title="$t('Delete')"
 >
 <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
 ...
 <div class="absolute -top-5 left-2 px-2 py-0.5 bg-admin-theme-primary/100 text-[10px] text-white rounded shadow-sm whitespace-nowrap z-30">
