<template>
 ...
 <div class="px-6 py-5 border-b border-admin-theme-border flex-shrink-0">
 <h2 class="text-lg font-semibold text-admin-theme-text">{{ $t('Menu structure') }}</h2>
 ...
 <div v-else class="text-center py-12 text-sm text-admin-theme-text-muted">
 ...
 <div 
 v-if="draggingId"
 class="h-24 mt-4 mb-12 border-2 border-dashed border-admin-theme-border/50 rounded-xl flex items-center justify-center transition-all bg-admin-theme-base/30 hover:border-indigo-400 hover:bg-admin-theme-primary/10/30 dark:hover:bg-indigo-900/10 group overflow-hidden"
 ...
 <span class="text-xs font-medium text-admin-theme-text-muted group-hover:text-admin-theme-primary">{{ $t('Drop here to move to end of root') }}</span>
 <ArrowDownIcon class="w-5 h-5 text-gray-400 group-hover:text-admin-theme-primary" />
 </div>
 </div>
 </div>
 </div>
