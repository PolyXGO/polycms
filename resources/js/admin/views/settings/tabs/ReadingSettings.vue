<template>
 ...
 <div class="space-y-4">
 <h3 class="text-sm font-medium text-admin-theme-text-secondary">
 ...
 class="mt-1 h-4 w-4 text-admin-theme-primary focus:ring-admin-theme-primary border-admin-theme-border"
 />
 <span class="ml-3 text-sm text-admin-theme-text-secondary">
 {{ $t('Your latest posts') }}
 </span>
 </label>
 <div class="space-y-4">
 ...
 <!-- Page Selectors -->
 <div v-if="getSettingValue('reading_show_on_front') ==='page'" class="ml-7 space-y-4 pl-4 border-l-2 border-admin-theme-border">
 <div class="flex items-center gap-4">
 <label for="reading_page_on_front" class="w-32 text-sm text-admin-theme-text-secondary">
 ...
 class="flex-1 max-w-md px-3 py-2 border border-admin-theme-border rounded-lg bg-admin-theme-input-bg text-admin-theme-text focus:ring-admin-theme-primary focus:border-admin-theme-primary"
 >
 ...
 <div class="flex items-center gap-4">
 <label for="reading_page_for_posts" class="w-32 text-sm text-admin-theme-text-secondary">
 ...
 <div class="flex-1">
 <button type="button" class="px-4 py-2 bg-admin-theme-primary text-admin-theme-primary-content rounded-lg hover:bg-admin-theme-primary-hover transition-colors" @click="openMediaPicker('reading_default_post_image')">
 ...
 <!-- Posts per page -->
 <div class="flex items-center gap-4">
 <label for="reading_posts_per_page" class="font-medium text-admin-theme-text-secondary">
 ...
 min="1"
 max="100"
 class="w-20 px-3 py-2 border border-admin-theme-border rounded-lg bg-admin-theme-input-bg text-admin-theme-text focus:ring-admin-theme-primary focus:border-admin-theme-primary"
 />
 <span class="text-sm text-admin-theme-text-secondary font-medium">{{ $t('posts') }}</span>
 </div>
 </div>

 <!-- Feed limit -->
 <div class="flex items-center gap-4">
 <label for="reading_feed_limit" class="font-medium text-admin-theme-text-secondary">
 ...
 class="w-20 px-3 py-2 border border-admin-theme-border rounded-lg bg-admin-theme-input-bg text-admin-theme-text focus:ring-admin-theme-primary focus:border-admin-theme-primary"
 />
 <span class="text-sm text-admin-theme-text-secondary font-medium">{{ $t('items') }}</span>
 </div>
 </div>
 ...
 />
 <span class="ml-3 text-sm text-admin-theme-text-secondary">{{ $t('Full text') }}</span>
 </label>
 <label class="flex items-center">
 <input
 type="radio"
 ...
 class="h-4 w-4 text-admin-theme-primary focus:ring-admin-theme-primary border-admin-theme-border"
 />
 <span class="ml-3 text-sm text-admin-theme-text-secondary">{{ $t('Excerpt') }}</span>
 </label>
 </div>
 </div>
 ...
 class="h-4 w-4 text-admin-theme-primary focus:ring-admin-theme-primary border-admin-theme-border rounded"
 />
 </div>
 <div class="ml-3 text-sm">
 <label for="reading_search_engine_noindex" class="font-medium text-admin-theme-text-secondary">
 {{ getSettingLabel('reading_search_engine_noindex') }}
 </label>
 <p class="text-admin-theme-text-muted">
