<template>
 ...
 :key="item.id"
 class="rounded-lg border border-admin-theme-border p-4 bg-admin-theme-base/70"
 >
 <div class="flex items-end gap-3 mb-3">
 <div class="flex gap-1">
 <button
 type="button"
 class="px-2 py-2 text-sm rounded border border-admin-theme-border hover:border-admin-theme-primary"
 :disabled="index === 0"
 ...
 v-model="item.title"
 type="text"
 class="w-full px-3 py-2 rounded-md border border-admin-theme-border bg-admin-theme-input-bg text-admin-theme-text placeholder-admin-theme-text-muted shadow-sm focus:border-admin-theme-primary focus:ring-admin-theme-primary sm:text-sm"
 ...
 <label class="mt-3 inline-flex items-center gap-2 text-sm text-admin-theme-text-secondary">
 <input
