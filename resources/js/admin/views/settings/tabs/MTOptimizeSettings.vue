<template>
 ...
 <label class="block text-sm font-medium text-slate-700 dark:text-slate-300">{{ getLabel('mtoptimize_cache_ttl_seconds', 'Metadata Cache TTL (seconds)') }}</label>
                        <input type="number" min="0" class="mt-1 w-full rounded-lg border border-admin-theme-border bg-admin-theme-input-bg px-3 py-2 text-admin-theme-text placeholder-admin-theme-text-muted focus:border-admin-theme-primary focus:outline-none focus:ring-1 focus:ring-admin-theme-primary"
 ...
 <label class="block text-sm font-medium text-slate-700 dark:text-slate-300">{{ getLabel('mtoptimize_sitemap_chunk_size', 'Sitemap Chunk Size') }}</label>
                        <input type="number" min="10" class="mt-1 w-full rounded-lg border border-admin-theme-border bg-admin-theme-input-bg px-3 py-2 text-admin-theme-text placeholder-admin-theme-text-muted focus:border-admin-theme-primary focus:outline-none focus:ring-1 focus:ring-admin-theme-primary"
 ...
 <label class="block text-sm font-medium text-slate-700 dark:text-slate-300">{{ getLabel('mtoptimize_sitemap_cache_ttl_seconds', 'Sitemap Cache TTL (seconds)') }}</label>
                        <input type="number" min="300" class="mt-1 w-full rounded-lg border border-admin-theme-border bg-admin-theme-input-bg px-3 py-2 text-admin-theme-text placeholder-admin-theme-text-muted focus:border-admin-theme-primary focus:outline-none focus:ring-1 focus:ring-admin-theme-primary"
 ...
 <input type="text" class="mt-1 w-full rounded-lg border border-admin-theme-border bg-admin-theme-input-bg px-3 py-2 text-admin-theme-text placeholder-admin-theme-text-muted focus:border-admin-theme-primary focus:outline-none focus:ring-1 focus:ring-admin-theme-primary"
 ...
 <input type="url" class="mt-1 w-full rounded-lg border border-admin-theme-border bg-admin-theme-input-bg px-3 py-2 text-admin-theme-text placeholder-admin-theme-text-muted focus:border-admin-theme-primary focus:outline-none focus:ring-1 focus:ring-admin-theme-primary"
 ...
 <textarea rows="3" class="mt-1 w-full rounded-lg border border-admin-theme-border bg-admin-theme-input-bg px-3 py-2 text-admin-theme-text placeholder-admin-theme-text-muted focus:border-admin-theme-primary focus:outline-none focus:ring-1 focus:ring-admin-theme-primary"
 ...
 <input type="checkbox" class="h-4 w-4 rounded border-slate-300" :checked="asBool('mtoptimize_noindex_search', true)" @change="setBool('mtoptimize_noindex_search', $event)" />
 {{ getLabel('mtoptimize_noindex_search','Noindex Search Pages') }}
 </label>
 <label class="flex items-center gap-3 rounded-lg border border-slate-200 bg-slate-50 px-3 py-2 text-sm text-slate-700 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-200">
 <input type="checkbox" class="h-4 w-4 rounded border-slate-300" :checked="asBool('mtoptimize_noindex_system', true)" @change="setBool('mtoptimize_noindex_system', $event)" />
 {{ getLabel('mtoptimize_noindex_system','Noindex System Pages') }}
 </label>
 <label class="flex items-center gap-3 rounded-lg border border-slate-200 bg-slate-50 px-3 py-2 text-sm text-slate-700 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-200">
 <input type="checkbox" class="h-4 w-4 rounded border-slate-300" :checked="asBool('mtoptimize_noindex_preview', true)" @change="setBool('mtoptimize_noindex_preview', $event)" />
 {{ getLabel('mtoptimize_noindex_preview','Noindex Preview Pages') }}
 </label>
 <label class="flex items-center gap-3 rounded-lg border border-slate-200 bg-slate-50 px-3 py-2 text-sm text-slate-700 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-200">
 <input type="checkbox" class="h-4 w-4 rounded border-slate-300" :checked="asBool('mtoptimize_suppress_pagination_links_on_noindex', true)" @change="setBool('mtoptimize_suppress_pagination_links_on_noindex', $event)" />
...
const checkPhysicalRobots = async () => {
 try {
 const response = await axios.get('/api/v1/admin/seo-tools/physical-robots');
 // Handle various response wrappers (axios response.data, or PolyCMS specific wrappers)
 const responseData = response.data || {};
 const actualData = responseData.data || responseData;
 hasPhysicalRobots.value = actualData.exists === true || responseData.exists === true;
 } catch (e) {
