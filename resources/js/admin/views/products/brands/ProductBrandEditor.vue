            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
                        <div class="space-y-4">
                            <div>
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">{{ $t('Parent Brand') || 'Parent Brand' }}</label>
                                <select
                    ...
                    <!-- Brand Logo -->
                    <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-3">{{ $t('Brand Logo') || 'Brand Logo' }}</label>
                        <div
                            @click="openMediaLibrary"
                            class="relative aspect-square rounded-lg border-2 border-dashed border-gray-300 dark:border-gray-600 flex flex-col items-center justify-center cursor-pointer hover:border-indigo-500 transition-colors overflow-hidden group"
                        >
                            ...
                            <template v-else>
                                ...
                                <span class="text-sm text-gray-500 dark:text-gray-400">{{ $t('Choose logo') || 'Choose logo' }}</span>
                            </template>
                        </div>
                    </div>
                </div>
