<template>
 ...
 <h1 class="text-2xl font-bold text-admin-theme-text">{{ $t('Product Categories') ||'Product Categories' }}</h1>
 <router-link
 ...
 <AdminLoadingState v-if="loading" :message="$t('Loading product categories...')" />
 ...
 <td colspan="4" class="px-6 py-4 text-center text-admin-theme-text-muted">
 No categories found.
 </td>
 </tr>
 </tbody>
