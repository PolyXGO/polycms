<template>
 ...
 <div>
 <p class="text-xs font-black uppercase tracking-[0.2em] text-admin-theme-primary">{{ kindLabel }}</p>
 <h1 class="mt-1 text-2xl font-bold text-admin-theme-text">
 ...
 <button
 type="button"
 class="rounded-lg border bg-admin-theme-input-bg px-4 py-2 text-sm font-semibold text-admin-theme-text-secondary transition-colors hover:bg-black/5 dark:hover:bg-admin-theme-input-bg/5 border-admin-theme-input-border"
 ...
 v-if="isEdit"
 type="button"
 class="rounded-lg border bg-admin-theme-input-bg px-4 py-2 text-sm font-semibold text-admin-theme-text-secondary transition-colors hover:bg-black/5 dark:hover:bg-admin-theme-input-bg/5 disabled:cursor-not-allowed disabled:opacity-60 border-admin-theme-input-border"
 :disabled="loading"
 ...
 v-if="!form.is_system"
 type="button"
 class="rounded-lg bg-admin-theme-primary px-4 py-2 text-sm font-semibold text-admin-theme-primary-content transition-colors hover:bg-admin-theme-primary-hover disabled:cursor-not-allowed disabled:opacity-60"
 :disabled="loading"
 @click="saveAsset"
 >
 ...
 v-if="!form.is_system"
 type="button"
 class="flex h-14 w-14 items-center justify-center rounded-full bg-admin-theme-primary text-admin-theme-primary-content shadow-lg shadow-indigo-500/30 transition-all hover:-translate-y-0.5 hover:bg-admin-theme-primary-hover disabled:cursor-not-allowed disabled:opacity-60"
 :disabled="loading"
...
const saveAsset = async () => {
 ...
 if (isEdit.value) {
 await axios.put(`/api/v1/layout-assets/${route.params.id}`, {
 ...payload,
 preview_image: null,
 });
 await loadAsset();
