...
'w-full flex items-center px-4 py-2.5 rounded transition duration-200',
 isOpen && !collapsed ?'bg-admin-theme-sidebar-active text-admin-theme-sidebar-text-active' :'text-admin-theme-sidebar-text hover:bg-admin-theme-sidebar-hover hover:text-admin-theme-sidebar-text-active',
 ...
 <span v-if="!collapsed && item.badge" class="ml-2 px-1.5 py-0.5 text-[10px] font-bold rounded-full bg-blue-600 text-white min-w-[18px] text-center leading-none">{{ item.badge }}</span>
 </div>
 <svg
 v-if="!collapsed"
...
'block px-4 py-2 rounded transition duration-200 truncate',
 isChildActive(child) ?'bg-admin-theme-sidebar-active text-admin-theme-sidebar-text-active' :'text-admin-theme-sidebar-text hover:bg-admin-theme-sidebar-hover hover:text-admin-theme-sidebar-text-active'
 ]"
 @click="onNavClick"
 >
 {{ child.label }}
 ...
 class="fixed w-48 bg-admin-theme-sidebar rounded-md shadow-lg border border-admin-theme-sidebar-hover z-[9999] py-1"
 :style="floatingStyle"
 @mouseenter="handleMouseEnter"
 @mouseleave="handleMouseLeave"
 >
 ...
 <div class="px-4 py-2 border-b border-admin-theme-sidebar-hover font-bold text-admin-theme-sidebar-text-active text-sm bg-admin-theme-sidebar-active rounded-t-md">
 {{ item.label }}
 </div>
 <router-link
 v-for="child in item.children"
...
'block px-4 py-2 text-sm transition duration-200',
 isChildActive(child) ?'bg-admin-theme-sidebar-hover text-admin-theme-sidebar-text-active' :'text-admin-theme-sidebar-text hover:bg-admin-theme-sidebar-hover hover:text-admin-theme-sidebar-text-active'
 ]"
 @click="onNavClick"
 >
 {{ child.label }}
...
'flex items-center px-4 py-2.5 rounded transition duration-200',
 isItemActive() ?'bg-admin-theme-sidebar-active text-admin-theme-sidebar-text-active' :'text-admin-theme-sidebar-text hover:bg-admin-theme-sidebar-hover hover:text-admin-theme-sidebar-text-active',
