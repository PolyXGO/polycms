...
'relative group border-2 rounded-lg p-4 transition-all',
 ...
 class="w-full px-4 py-3 border-2 border-dashed border-gray-300 rounded-lg text-gray-500 hover:border-admin-theme-primary hover:text-admin-theme-primary transition-colors"
 >
 + Add Block
 </button>
 </div>
 ...
 class="p-4 border border-gray-200 rounded-lg hover:border-admin-theme-primary hover:bg-admin-theme-primary/10 transition-colors text-left"
 >
