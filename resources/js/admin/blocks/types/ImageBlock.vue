<template>
 ...
 class="text-gray-500 hover:text-admin-theme-primary"
 >
 ...
 />
 <div v-else class="mt-2 text-sm text-admin-theme-text-secondary">
 Alt: {{ attrs.alt ||'No alt text' }}
 <button type="button" @click="editingAlt = true" class="ml-2 text-admin-theme-primary hover:text-admin-theme-primary-hover dark:text-admin-theme-primary dark:hover:text-admin-theme-primary">Edit</button>
 </div>
 </div>
 <!-- Media Picker -->
 <MediaPicker
...
const handleMediaSelect = (media: any) => {
 ...
 alt: selected.name || selected.file_name || attrs.alt ||'',
 });
};
</script>
