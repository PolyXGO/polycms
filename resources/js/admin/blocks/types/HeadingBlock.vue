<template>
 ...
 class="w-full text-2xl font-bold border-none outline-none bg-transparent text-admin-theme-text"
 ...
 class="text-2xl font-bold cursor-pointer hover:bg-admin-theme-base rounded px-2 py-1 text-admin-theme-text"
 >
