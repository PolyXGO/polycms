<template>
 <div class="block-grid border-2 border-dashed border-admin-theme-border rounded-lg p-4">
 ...
 class="text-sm border border-admin-theme-border rounded px-2 py-1 bg-admin-theme-input-bg text-admin-theme-text"
 >
 ...
 :key="`col-${colIndex}`"
 class="border border-admin-theme-border rounded p-2 min-h-[100px] bg-admin-theme-base/50"
 >
 <div class="text-xs text-admin-theme-text-muted mb-2">Column {{ colIndex + 1 }}</div>
 <div class="space-y-2">
 <div
 ...
 class="w-full px-3 py-2 border border-dashed border-admin-theme-border rounded text-admin-theme-text-muted hover:border-admin-theme-primary dark:hover:border-indigo-400 hover:text-admin-theme-primary dark:hover:text-admin-theme-primary text-sm"
 >
 + Add Block
 </button>
 </div>
 ...
 >
 <div class="bg-admin-theme-surface rounded-lg shadow-xl max-w-2xl w-full m-4 max-h-[80vh] overflow-hidden flex flex-col">
 <div class="px-6 py-4 border-b border-admin-theme-border flex justify-between items-center">
 <h3 class="text-lg font-semibold text-admin-theme-text">Add Block to Column {{ pickerColumn + 1 }}</h3>
 <button type="button" @click="pickerColumn = null" class="text-admin-theme-text-muted hover:text-admin-theme-text">
 ...
 class="p-4 border border-admin-theme-border rounded-lg hover:border-admin-theme-primary hover:bg-admin-theme-primary/10 dark:hover:bg-indigo-900/20 transition-colors text-left"
 >
 <div class="text-sm font-medium text-admin-theme-text">{{ blockType.label }}</div>
 <div v-if="blockType.category" class="text-xs text-admin-theme-text-muted mt-1">{{ blockType.category }}</div>
 </button>
 </div>
 </div>
 </div>
